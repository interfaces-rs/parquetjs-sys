...
extern {
    ...
    #[wasm_bindgen(method, getter, js_name = "dLevelMax")]
    ...
    #[wasm_bindgen(method, getter, js_name = "originalType")]
    pub fn original_type(this: &Field) -> Option<JsString>;

    #[wasm_bindgen(method, getter, js_name = "primitiveType")]
    pub fn primitive_type(this: &Field) -> Option<JsString>;

    #[wasm_bindgen(method, getter)]
    pub fn path(this: &Field) -> Array;

    #[wasm_bindgen(method, getter, js_name = "rLevelMax")]
    pub fn r_level_max(this: &Field) -> Option<Number>;

    #[wasm_bindgen(method, getter, js_name = "repetitionType")]
    pub fn repetition_type(this: &Field) -> JsString;

    #[wasm_bindgen(method, getter, js_name = "typeLength")]
